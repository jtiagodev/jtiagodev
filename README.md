...
[<img align="left" alt="jtiagodev | YouTube" width="22px" src="https://cdn.jsdelivr.net/npm/simple-icons@v3/icons/youtube.svg" />][youtube]
...
[<img align="left" alt="jtiagodev | Instagram" width="22px" src="https://cdn.jsdelivr.net/npm/simple-icons@v3/icons/instagram.svg" />][instagram]
...
- [Microinteractions: Password Validation Animation](https://dev.to/jtiagodev/microinteractions-password-validation-animation-5629)
- [Notion + YouTube - A Powerful Combination for Productivity](https://dev.to/jtiagodev/notion-youtube-a-powerful-combination-for-productivity-1def)
- [Regular Expressions (RegEx) Crash Course](https://dev.to/jtiagodev/regular-expressions-regex-crash-course-248n)
- [Emmet Part 2 - Advanced](https://dev.to/jtiagodev/emmet-part-2-advanced-4c65)
- [Deno 1.0 Released! (Easy) REST API Example](https://dev.to/jtiagodev/deno-1-0-released-easy-rest-api-example-2fbl)
<!-- BLOG-POST-LIST:END -->
